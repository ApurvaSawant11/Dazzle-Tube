...
export const videos = [
  ...
  },
  {
    _id: "xL6wySUJXbE",
    title:
      "ASMR Process of Making Tako Pot | Full Process of Ceramic | Studio Vlog | ASMR Vlog",
    description:
  ...
  },
  {
    _id: "erXfC_hs7Ew",
    title:
      "ASMR Making Giraffe Ceramic Pot | Process of Ceramic | Studio Vlog | ASMR Vlog | Clay ASMR",
    description:
      "Hi there, thanks for coming by. I am a freelance ceramist, my mission is turn clay into animals that cheer you up. Feel free to head to my Instagram or website if you are curious about what I make. I hope you enjoyed my vlog!",
    creator: "Amii Ceramics",
    category: "pottery",
...

  {
    _id: "B_qhDw4Ps7g",
    title:
      "CERAMIC POTS, PLANTERS & MUCH MORE AT FACTORY PRICE | DNF CERAMICS KHURJA | HOW TO MAKE CERAMIC ITEM",
    description:
...

  {
    ...
    description: "The full process of making a Pebble Cup/Mug.",
...

  {
    _id: "N1LoztmlZ4Q",
    title:
      "DIY hand painted Plate | Jaipur Blue pottery painting | Ceramic or Melamine plate painting|Upcycling",
    description:
...

  {
    _id: "bStNpajvHcU",
    title:
      "painting for beginners - painting tutorial on how to paint flowers on ceramic plate - diy",
    description:
...

  {
    _id: "NJZxcAvdyJ0",
    title:
      "ASMR Ceramic Duck Planter Making of Process | Full Process of Ceramic | Studio Vlog | ASMR Vlog",
    description:
      "Hi there, thanks for coming by. I am a freelance ceramist, my mission is to turn clay into animals that cheer you up. Feel free to head to my Instagram or website if you are curious about what I make. I hope you enjoyed my vlog!",
    creator: "Amii Ceramics",
    category: "planter",
  ...
  {
    _id: "k4eiFQI6ivo",
    title: "Making cute air dry clay planter from plastic 🌱 vlog",
    description: "making cute air dry clay planter from plastic 🌱 vlog",
    creator: "miieu",
    category: "planter",
...

  {
    ...
    description:
      "Here's the ASMR version of my teapot making video for those who prefer the simple sounds from the studio. ",
    creator: "Florian Gadsby",
    category: "pottery",
